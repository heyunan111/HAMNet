...
address_v6::address_v6(const char *str) noexcept {
  inet_pton(AF_INET6, str, &addr_);
}

address_v6::address_v6(std::string_view str) noexcept
    : address_v6(str.data()) {}

address_v6::address_v6(const std::string &str) noexcept
    : address_v6(str.c_str()) {}
